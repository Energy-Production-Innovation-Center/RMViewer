...
rmviewer = RMViewer(
    solutions=solutions_ids, dataset=dataset_normalization, solutions_results=df
)
...
attribute_results =pd.read_csv("/Documentos/test_viewer/test1/attribute_levels_objective_function.csv") 
